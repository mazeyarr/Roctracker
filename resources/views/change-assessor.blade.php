        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <h3 class="box-title m-b-0">Basistraining</h3>
                    <div class="form-group">
                        <div class="checkbox">
                            <input type="checkbox" name="Portfolio" id="Portfolio"> <label for="Portfolio"> Portfolio</label>
                        </div>
                        <div class="checkbox">
                            <input type="checkbox" name="CV" id="CV"> <label for="CV"> CV</label>
                        </div>
                        <div class="checkbox">
                            <input type="checkbox" name="Filmpje" id="Filmpje"> <label for="Filmpje"> Filmpje</label>
                        </div>
                        <div class="checkbox">
                            <input type="checkbox" name="Geslaagd" id="Geslaagd"> <label for="Geslaagd"> Geslaagd</label>
                        </div>
                    </div>
                <hr>
                    <div class="form-group">
                        <div class="checkbox">
                            <input type="checkbox" name="present_day_1" id="day_1"> <label for="day_1"> Present</label>
                        </div>
                        <div class="form-group">
                        ...
                        <hr>
                        <div class="checkbox">
                            <input type="checkbox" name="present_day_2" id="day_2"> <label for="day_2"> Present</label>
                        </div>
                        <div class="form-group">
