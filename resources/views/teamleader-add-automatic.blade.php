...
@section('title', 'Teamleider Automatisch Toevoegen')

@section('page-title', 'Teamleider Automatisch Toevoegen')
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="white-box">
                                        ...
                                        <form action="{!! URL::route('add_teamleader_automatic_save') !!}" id="upload-list" class="dropzone">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            btnDownload.click(function () {
                var win = window.open('{!! URL::route('download_excel_teamleader_layout') !!}', '_blank');
                if (win) {
            ...
            btnUndo.click(function () {
                ...
                var url = "{!! URL::route('add_teamleader_automatic_undo', 'none') !!}";
