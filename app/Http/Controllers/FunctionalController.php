...
class FunctionalController extends Controller
{
    ...
    public function downloadExcelTeamleaderLayout () {
        Excel::create('Teamleider Lijst Layout', function ($excel) {

            // Set the title
            $excel->setTitle('Teamleider Lijst Layout');

            // Chain the setters
            $excel->setCreator('RocTracker')
                ->setCompany('MRG Studios')
                ->setTitle('Teamleider Lijst')
                ->setDescription('Deze layout zal gebruikt worden om teamleider lijsten te importeren in het systeem');
