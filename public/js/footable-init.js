$(window).on('load', function() {
	...
	// Row Toggler
	// -----------------------------------------------------------------
	$('#college-footable').footable();

	// Accordion
	// -----------------------------------------------------------------
	$('#college-footable').footable().on('footable_row_expanded', function(e) {
		$('#college-footable tbody tr.footable-detail-show').not(e.row).each(function() {
			$('#college-footable').data('footable').toggleDetail(this);
		});
	});
	...
	$('#demo-show-entries').change(function (e) {
		...
		$('#college-footable').data('page-size', pageSize);
		$('#college-footable').trigger('footable_initialized');
	});
