...
return array(
    ...
    'properties' => [
        'creator'        => 'Mazeyar Rezaei',
        'lastModifiedBy' => 'RocTracker',
        'title'          => 'Spreadsheet',
        'description'    => 'Excel uitdraai van het RocTracker systeem',
        'subject'        => 'Lijst',
        'keywords'       => 'RocTracker, Assessoren, Colleges, Teamleiders',
        'category'       => 'Excel',
        'manager'        => 'Mazeyar Rezaei',
        'company'        => 'MRG Studios',
    ],
